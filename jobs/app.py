import sqlite3
import datetime
from flask import Flask, render_template, g, request, ridirect, url_for
...
def review(employer_id):
    if request.method == 'POST':
        ...
        execute_sql('INSERT INTO review (review, rating, title, date, status, employer_id) VALUES (?, ?, ?, ?, ?, ?)', (review, rating, titke, date, status, employer_id), commit = True)
